...
export default function LibraryScreen({
  ...
  return (
    <div className="flex flex-col h-full w-full max-w-7xl mx-auto px-4 sm:px-6 py-6 overflow-y-auto animate-fade-in text-light-text dark:text-dark-text">
      ...
      {/* LAYOUT PRINCIPAL DE 2 COLUMNAS (12 COLS GRID) */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full flex-1">
        {/* COLUMNA IZQUIERDA: CONTENIDO PRINCIPAL (lg:col-span-8) */}
        <div className="lg:col-span-8 flex flex-col gap-6">
          ...
          <div className="flex-1">
            ...
            {subjects.length === 0 ? (
              ...
              <div className="flex flex-col items-center justify-center p-10 text-center bg-light-card dark:bg-dark-card rounded-3xl border border-frida-primary/15 dark:border-dark-muted shadow-sm animate-fade-in transition-colors duration-300 my-2">
                    ...
                    <div className="relative group shrink-0">
                      ...
                      <div className="relative p-2 rounded-full bg-white/20 dark:bg-white/10 border border-frida-primary/20 backdrop-blur-sm">
                        <img
                          ...
                          className="h-24 w-24 object-contain hover:scale-105 transition-transform duration-200"
                        />
                      </div>
                    </div>
        ...
        {/* COLUMNA DERECHA: SIDEBAR DE ACTIVIDAD Y HEATMAP (lg:col-span-4) */}
